insert into person (id, first_name, last_name, reg_date, birth_date, e_mail, phone, city, country, is_approved, is_blocked, is_online, message_permission, last_online_time, about, photo, password)
...
insert into notification_type (id, code, name) values (1, 1, 'POST');
insert into notification_type (id, code, name) values (2, 2, 'POST_COMMENT');
insert into notification_type (id, code, name) values (3, 3, 'COMMENT_COMMENT');
insert into notification_type (id, code, name) values (4, 4, 'FRIEND_REQUEST');
insert into notification_type (id, code, name) values (5, 5, 'MESSAGE');
